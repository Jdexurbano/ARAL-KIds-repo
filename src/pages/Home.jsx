      ...
      >
        <div className="desktop:flex desktop:justify-between desktop:items-start">
          <div className="flex flex-col items-center desktop:items-start">
            <div className="text-center desktop:text-left font-extrabold text-[40px] desktop:text-[55px] large:text-[65px] text-slate-100">
              <h1>
            ...
            <div className="mb-[10px] font-semibold desktop:font-bold">
              <button className="py-[11px] desktop:py-[21px] px-[16px] desktop:px-[32px] bg-fourth rounded-[10px] mr-[5px]">
                <h1 className="text-slate-200">Download Now</h1>
              </button>
              <button className="py-[10px] desktop:py-[20px] px-[20px] desktop:px-[40px] bg-slate-200 rounded-[10px] ml-[5px] border-[2px] border-fifth hover:bg-fifth duration-300 text-fifth hover:text-slate-200">
